    ...
    public final void handlePacket(InPacket p, Client c) {
        ...
        */
        ...
        if (skillid % 10000000 == 1020) {
            ...
            // Consume the charge, then pierce the yetis' evasion for the skill's duration so the
            // massacre skill is the one reliable way to hit the otherwise-unhittable yetis.
            py.empowerYetisForMassacre(chr, skill);
            skillLevel = 1;
        }

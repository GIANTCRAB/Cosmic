...
public class Server {
    ...
    private int initWorld() {
        ...
        int meleeboosteddroprate = YamlConfig.config.worlds.get(i).melee_boosted_drop_rate;
        final var questrate = YamlConfig.config.worlds.get(i).quest_rate;
        ...
        World world = new World(i,
                flag,
                event_message,
                exprate, droprate, bossdroprate, meleeboosteddroprate, mesorate, questrate, travelrate, fishingrate);
